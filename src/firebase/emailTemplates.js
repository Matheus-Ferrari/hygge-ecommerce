const BRAND = {
  name: 'Hygge Games',
  // Cores inspiradas em src/css/style.css
  green: '#008366',
  greenDark: '#005c3c',
  accent: '#FAE696',
  background: '#f3eee9',
...
function messageToHtml(message) {
  // Permite passar string simples; converte quebras de linha em <br>.
  // Para blocos extras (tabela de pedido, etc.), use contentHtml.
...
/**
 * Gera um template de e-mail com estilos inline, inspirado no design do site.
 *
 * Assinatura:
 * generateEmailTemplate({ title, message, buttonText, buttonLink, footerText, contentHtml })
 */
